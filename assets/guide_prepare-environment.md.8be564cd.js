import{_ as s,c as n,o as a,a as p}from"./app.3a14271c.js";const C=JSON.parse('{"title":"Preparar Entorno","description":"","frontmatter":{},"headers":[],"relativePath":"guide/prepare-environment.md"}'),l={name:"guide/prepare-environment.md"},o=p(`<h1 id="preparar-entorno" tabindex="-1">Preparar Entorno <a class="header-anchor" href="#preparar-entorno" aria-hidden="true">#</a></h1><div class="language-"><span class="copy"></span><pre><code><span class="line"><span style="color:#A6ACCD;">npm init vite@latest</span></span>
